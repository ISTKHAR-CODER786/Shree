...
#
# This file is part of < https://github.com/TheAloneTeam/ROCKYMUSIC > project,
# and is released under the "GNU v3.0 License Agreement".
# Please see < https://github.com/TheAloneTeam/ROCKYMUSIC/blob/master/LICENSE >
#
# All rights reserved.
...
async def get_thumb(videoid):
    ...
    try:
        ...
        stats_text = f"YouTube : {views} | Time : {duration} | Player : @ShreeViaBot"
